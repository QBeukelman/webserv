...
/*   Updated: 2025/09/01 13:07:42 by quentinbeuk   ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
// POST with body
static const char HTTP_REQUEST_POST[] = "POST /submit-form?debug=true HTTP/1.1\r\n"
...
// POST with arge body
static const char HTTP_REQUEST_POST_WITH_BODY[] = "POST /submit-form?debug=true HTTP/1.1\r\n"
												  "Host: www.example.com\r\n"
												  "User-Agent: curl/7.68.0\r\n"
												  "Content-Type: application/x-www-form-urlencoded\r\n"

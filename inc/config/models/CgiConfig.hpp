...
/*   Updated: 2025/10/07 15:24:37 by quentinbeuk   ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
struct CgiConfig
{
	...
	CgiConfig() : extension(""), executable_path(""), working_directory("") {};
};

std::ostream &operator<<(std::ostream &out, std::optional<CgiConfig> &cgiConfig);
